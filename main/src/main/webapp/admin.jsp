...
<div class="container  ">
  <div class="row">
    <div class="col-md-10"> 
    <img style="max-width: 150px;" src="img/add-to-basket.png" class="img-thumbnail" data-toggle="modal" data-target="#exampleModal"   alt="...">
      <h4 class="text=muted text-info bg-light">+Category</h4>
    </div>
    <div class="col-md-2">
    <img style="max-width: 150px;"  src="img/add-to-cart.png" class="img-thumbnail" data-toggle="modal" data-target="#exampleModal1" alt="...">
