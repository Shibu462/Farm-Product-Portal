    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav justify-content-between w-100">
        ...
        <% 
        	   ...
        	   <span><img src="img/cartimg.jpg" alt="" style="height:40px;width:40px" data-toggle="modal" data-target="#cart-modal"></span>  
               <a class="nav-link "   href="#" data-toggle="modal" data-target="#cart-modal"><%=user1.getUserName() %><span class="ml-0 cart-items"><img alt="0" src=""></span></a>
             </li>    
        	   <li class="nav-item">
