...
<div class="col-md-2"> 
 ...
 <br> 
  ...
  <img src="img/products/<%=p.getpPhoto()%>" class="card-img-top" style="max-height: 190px; width:100%; margin-top:5px;"alt="...">
  <div class="card-body">
    <h5 class="card-title text-center text-uppercase text-secondary"><%= p.getpName() %></h5>
    <p class="card-text text-center text-lowercase text-muted"><%=Helper.get10Words(p.getpDesc())%></p>   
